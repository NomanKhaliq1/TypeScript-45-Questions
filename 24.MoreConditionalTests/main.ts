...
console.log("\nTests using 'and' and 'or' operators");
let testAndTrue: boolean = (5 > 3) && (10 < 15);
let testAndFalse: boolean = (5 > 3) && (10 > 15);

let testOrTrue: boolean = (5 > 3) || (10 > 15);
let testOrFalse: boolean = (5 < 3) || (10 > 15);
...
console.log("\nTest whether an item is not in a array");
const fruits2: string[] = ['apple', 'banana', 'orange', 'grape', 'kiwi'];
const fruitToCheck2: string = 'Mango';
